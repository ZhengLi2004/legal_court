...
ANALYZE_PROJECTION_PROMPT = """
    你是一个法律辩论团队的【首席战略参谋】。
    我们刚刚根据你的查询意图，从历史案例库中“投影”了一些相关的论证片段到当前的战局中。
    ...
    【任务】:
    请基于这些新注入的情报，为你的指挥官（律师）提炼出核心价值和 actionable advice。
    请不要复述情报内容，而是要回答以下问题：
    1.  **核心洞察**: 这些历史经验揭示了哪些新的攻击角度、防守策略或证据用法？
    2.  **战术建议**: 基于这些洞察，我们下一步应该具体做什么？（例如：我们应该主张'CLAIM_abc'，并用'LAW_xyz'和'FACT_123'来支持它）。
    3.  **潜在风险**: 对方可能会如何反驳这些新论点？我们需要提前准备什么？

    请以简练、专业的法律顾问口吻，输出一段纯文本的战略建议。
"""
