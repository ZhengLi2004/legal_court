...
def utc_now_iso() -> str:
    ...
    Returns:
        UTC timestamp string generated by `datetime.now(timezone.utc).isoformat()`.
    """
...
class SessionManager:
    ...
    def export_graph_gexf(
        ...
        Returns:
            GEXF bytes for download/export APIs.
        """
    ...
    def export_replay_bundle(
        ...
        """Export replay bundle for offline restore or analysis.

        Args:
            session_id: Session identifier.
            include_events_limit: Maximum event rows to include.
            include_artifacts_limit: Maximum artifact rows to include.

        Returns:
            Replay bundle payload with snapshots/events/artifacts.
        """
