...
def render_global_memory(snapshot):
    ...
    if im and im.insights:
        ...
        if os.path.exists("./temp_viz/insights.png"):
            st.image("./temp_viz/insights.png", caption="Insight Graph")

    else:
        st.info("💡 暂无已学习的 Insight。")
    ...
    if tl and tl.graph.number_of_nodes() > 0:
        ...
        if os.path.exists("./temp_viz/topology.png"):
            st.image("./temp_viz/topology.png", caption="Case Topology Graph")
