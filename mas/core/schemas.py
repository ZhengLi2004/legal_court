...
class MessageType(str, Enum):
    ...
    Attributes:
        INSTRUCTION: Controller-to-worker instruction message.
        REPORT: Worker-to-controller report message.
    """
...
class WorkerInstruction(BaseModel):
    ...
    Attributes:
        message_type: Discriminator for instruction payloads.
        intent: Worker task intent text.
    """
...
class WorkerReportStatus(str, Enum):
    ...
    Attributes:
        FOUND: Worker found useful evidence or advice.
        NOT_FOUND: Worker completed successfully but found nothing useful.
        ERROR: Worker failed to execute normally.
    """
...
class WorkerReport(BaseModel):
    ...
    Attributes:
        message_type: Discriminator for report payloads.
        status: Report status.
        content: Natural-language report text.
        max_score: Best retrieval score observed by the worker.
    """
...
class AgentActionType(str, Enum):
    ...
    Attributes:
        CITE_FACT: Cite a fact node.
        CITE_LAW: Cite a law node.
        SUPPORT_CLAIM: Add a supporting claim relation.
        REBUT_CLAIM: Add a rebutting claim relation.
    """
...
class AgentAction(BaseModel):
    ...
    Attributes:
        ...
        metadata: Optional structured action metadata.
    """
...
class ResourceRequirement(BaseModel):
    ...
    Attributes:
        need: Whether a worker call is necessary.
        reasoning: Natural-language explanation for the decision.
        intent: Optional worker intent text when delegation is required.
    """
