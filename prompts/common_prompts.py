...
ASSESS_FACT_NEEDS_PROMPT = (
    ...
    {{
        "need": true,
        "reasoning": "作为被告，我看到原告主张了[核心诉求]...，但我需要找到关于...",
...
ASSESS_LAW_NEEDS_PROMPT = (
    ...
    {{
        "need": true,
        "reasoning": "我是原告，我想主张合同无效，但图谱中缺少关于合同无效的具体法律条款节点...",
...
ASSESS_RECALL_NEEDS_PROMPT = (
    ...
    {{
        "need": true,
        "reasoning": "作为被告，我想看看在类似的合同纠纷中，是否存在成功的抗辩先例。",
